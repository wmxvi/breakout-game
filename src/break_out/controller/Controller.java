 ...
 * 
 * @author dmlux, modified by I. Schumacher and I. Traupe and Nele Meyer and Drenusha Emrulahu
 *
 */
public class Controller implements ActionListener, KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		if(e.getKeyCode() == KeyEvent.VK_SPACE) {
			if(this.game.getLevel().ballWasStarted() == false) {
			    this.game.getLevel().startBall();
		    }
			else if(this.game.getLevel().ballWasStarted() == true) {
				this.game.getLevel().stopBall();
			}
		}
		if(e.getKeyCode() == KeyEvent.VK_LEFT) {
			this.game.getLevel().getPaddle().setDirection(-1);
		}
		if(e.getKeyCode() == KeyEvent.VK_RIGHT) {
			this.game.getLevel().getPaddle().setDirection(1);
		}
		if(e.getKeyCode() == KeyEvent.VK_ESCAPE) {
			this.game.getLevel().setFinished(true);
			this.toStartScreen();
		}
	}
	...
	public void keyReleased(KeyEvent e) {
		if(e.getKeyCode() == KeyEvent.VK_LEFT  || e.getKeyCode() == KeyEvent.VK_RIGHT) {
			this.game.getLevel().getPaddle().setDirection(0);
		}
	}

	/**
	 * This method switches the view to the StartScreen view and shows the result.
	 */
