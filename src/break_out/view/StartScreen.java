...
public class StartScreen extends JPanel {
	...
	private void initializeScoreMenu() {
		...
		nameAndScore.setFont(new Font("Sans-serif", Font.PLAIN, 16));
		nameAndScore.setHorizontalAlignment(SwingConstants.CENTER);
		scoreMenu.add(nameAndScore, "cell 0 4, gaptop 25");
	...
	/**
	 * Shows the result when leaving the game
	 */
	public void showNameAndScore() {
		nameAndScore.setText("Spieler " + playersName.getText() + " hat " + 
                view.getGame().getLevel().getScore() + " Punkte erzielt");
	}
